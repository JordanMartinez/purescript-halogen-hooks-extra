...
foreign import data UseEvent :: Type -> Hooks.HookType
...
instance newtypeUseEvent
  :: HookEquals (UseEvent' m a) h
  => HookNewtype (UseEvent a) h
...
useEvent :: forall m a
   . MonadEffect m
  => Hook m (UseEvent a) (UseEventApi m a)
useEvent = Hooks.wrap hook
  ...
  hook = Hooks.do
    ...
    _ /\ ref <- Hooks.useRef { valueCB: Nothing, unsubscribeCB: Nothing }
